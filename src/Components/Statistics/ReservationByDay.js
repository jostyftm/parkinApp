...
import { reservationByDay, reservationByState } from "../../Services/statisticsService";
...
const ReservationByDayComponent = () => {
    ...
    const fetchData = async () => {
        ...
        try{
            const responseData = await reservationByDay();
...
export default ReservationByDayComponent;